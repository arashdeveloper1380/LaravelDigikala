                        ...
                        <li><span class="fa fa-angle-left"></span> <span>{{ $category2->cat_name }}</span>
                            <ul>
                                @foreach($cat_list as $key=>$value)
                                    ...
                                    <?php
                                    $url=url('');
                                    $e=explode('_',$value->cat_ename);
                                    if(sizeof($e)==3)
                                    {
                                        if($e[0]=='filter')
                                        {
                                            $url.='/search/'.$category1->cat_ename.'/'.$category2->cat_ename.'/'.$category3->cat_ename.'?'.$e[1].'[0]='.$e[2];
                                        }
                                        else
                                        {
                                            $url.='/category/'.$category1->cat_ename.'/'.$category2->cat_ename.'/'.$category3->cat_ename.'/'.$value->cat_ename;
                                        }
                                    }
                                    else
                                    {
                                    ...
                                    @if(!array_key_exists($value->cat_ename,$a))
                                        ...
                                        <li>
                                            <a href="{{ $url }}">{{ $value->cat_name }}</a></li>
                                    @endif
